...
const ModalDetalle = ({ isOpen, onClose, id, title, stock, price, image, FechaDeVencimiento }: ModalInvenProps) => {

    const [descuentoBodega, setDescuentoBodega] = useState<string>('');
    const [totalDescuento, setTotalDescuento] = useState<string>('0');



    useEffect(() => {
        const bodega = parseInt(stock.toString().replace(/[^0-9]/g, '')) || 0;
        const quitar = parseInt(descuentoBodega.replace(/[^0-9]/g, '')) || 0;
        const resultado = bodega - quitar;
        setTotalDescuento(resultado.toString());
    }, [stock, descuentoBodega]);
                            ...
                            <>
                                ...
                                <View className="flex-row gap-3 mb-6">
                                    ...
                                    <View className="flex-1">
                                        ...
                                        <View className="bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800 rounded-lg p-4 items-center">
                                            <TextInput
                                                className="text-red-700 dark:text-red-300 text-2xl font-bold"
                                                keyboardType="numeric"
                                                value={descuentoBodega}
                                                onChangeText={setDescuentoBodega}
                                                placeholder="0"
                                            />
